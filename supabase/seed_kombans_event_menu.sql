...
cross join (values
  ...
  ('Chicken Biriyani',        'Lunch',       13.00, 20, '🍛'),
  ('Paneer Biriyani',         'Lunch',       13.00, 20, '🧀'),
  ('Pazhampori',              'Snacks',       1.50,  6, '🍌'),
  ('Chicken Roll',            'Snacks',       2.00,  8, '🌯'),
...
join public.recipes r
  on r.org_id = o.id
 and r.name in (
   'Chicken Wrap','Chicken Biriyani','Paneer Biriyani',
   'Pazhampori','Chicken Roll','Onion Pakoda',
