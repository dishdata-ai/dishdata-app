-- ============================================================================
-- 0028 · Tournament-priced items are POS-only, never orderable via the
-- public/QR storefront. The storefront menu query already excludes them
-- (fetchPublicMenu / fetchPublicMenuServer), but place_public_order must
-- reject them too in case of a stale cached page or a replayed request.
-- ============================================================================
