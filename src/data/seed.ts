...
export function buildSeed(orgId: string): SeedBundle {
  ...
  const addRecipe = (
    ...
    const id = uid();
    recipes.push({ id, org_id: orgId, name, category, price, prep_minutes: prep, emoji, description: null, name_de: null, description_de: null, category_de: null, image_url: null, is_active: true, sold_out_until: null, tax_rate: category === "Beverages" ? 19 : null, diet: null });
