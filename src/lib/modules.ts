...
export const ROLE_DEFAULT_MODULES: Record<Role, "all" | string[]> = {
  ...
  admin: "all",
  partner: "all",
  manager: ["dashboard", "myday", "pos", "orders", "channels", "kitchen", "floor", "recipes", "inventory", "procurement", "delivery", "sales", "insights", "menu", "reports", "staff", "timeclock", "tasks", "crm", "zreport"],
  staff: ["dashboard", "myday", "pos", "orders", "channels", "kitchen", "floor", "timeclock", "tasks"],
